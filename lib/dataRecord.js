class  dataRecord{
    ...
    constructor() {
        ...
        this.rumia_speed_Slow = 72;
        this.rumia_defense_radius = 52;

        //speed
        this.emeny_speed_normal1 = 170;
        this.emeny_speed_slow1 = 70;
        this.emeny_speed_normal2 = 110;
        this.emeny_speed_normal3 = 170;
        this.emeny_speed_normal4 = 200;
        //boss
